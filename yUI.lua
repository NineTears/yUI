    ...
    for i = 1, NUM_ACTIONBAR_BUTTONS do
        yUI_SetFrameStrata(_G["ActionButton" .. i])
        yUI_SetFrameStrata(_G["MultiBarBottomRightButton" .. i])
        yUI_SetFrameStrata(_G["MultiBarBottomLeftButton" .. i])
        yUI_SetFrameStrata(_G["MultiBarLeftButton" .. i])
        yUI_SetFrameStrata(_G["MultiBarRightButton" .. i])
    end
    ...
    yUI_autoCleanFrame:RegisterEvent("PLAYER_ENTERING_WORLD")
    yUI_autoCleanFrame:SetScript("OnUpdate", startTimer)
